...
namespace SCIMSApi.Migrations
{
    ...
    [Migration("20210208101047_DesigantionInformation")]
    partial class DesigantionInformation
    {
            ...
            modelBuilder.Entity("SCIMSApi.Models.ClassRoomInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 72, DateTimeKind.Local), Description = "Test Class Room", IsActive = true, Name = "Class 1", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.CoursesInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 78, DateTimeKind.Local), Description = "Test Course", IsActive = true, Name = "Course One", SchoolId = 1, TotalMarks = 100 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.DepartmentInformation", b =>
                {
                    ...
                    b.ToTable("DepartmentInformation");

                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 98, DateTimeKind.Local), Description = "New test department added", IsActive = true, Name = "Urdu", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.DesignationInformation", b =>
                {
                    ...
                    b.ToTable("DesignationInformation");

                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 105, DateTimeKind.Local), Description = "New test Designation is created", IsActive = true, Name = "Test Desugnation", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.EmployeeInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 107, DateTimeKind.Local), DateofBirth = new DateTime(2021, 2, 8, 14, 10, 47, 107, DateTimeKind.Local), Description = "New Test Employee Added", IsActive = true, Name = "Test Employee", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.ExamInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 89, DateTimeKind.Local), ExamName = "First Term", IsActive = true, SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.SchoolInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "Abu Dhabi, UAE", CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 71, DateTimeKind.Local), IsActive = true, Logo = "this.png", Mobile = "91 45454655", Name = "Test School One", Phone = "0302 45454555", RegistrationNo = "011121110" }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.UserInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 2, 8, 14, 10, 47, 67, DateTimeKind.Local), FullName = "Admin", GenderId = 1, IsActive = true, UserName = "admin@gmail.com", UserPassword = "1234" }
                    );
                });
