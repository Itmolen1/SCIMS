...
namespace SCIMSApi.Migrations
{
    ...
    [Migration("20200707105100_ClassRoomCreate")]
            ...
            modelBuilder.Entity("SCIMSApi.Models.ClassRoomInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2020, 7, 7, 14, 50, 59, 702, DateTimeKind.Local), Description = "Test Class Room", IsActive = true, Name = "Class 1", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.SchoolInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "Abu Dhabi, UAE", CreatedBy = 1, CreatedDate = new DateTime(2020, 7, 7, 14, 50, 59, 701, DateTimeKind.Local), IsActive = true, Logo = "this.png", Mobile = "91 45454655", Name = "Test School One", Phone = "0302 45454555", RegistrationNo = "011121110" }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.UserInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2020, 7, 7, 14, 50, 59, 698, DateTimeKind.Local), FullName = "Admin", GenderId = 1, IsActive = true, UserName = "admin@gmail.com", UserPassword = "1234" }
                    );
                });
