...
namespace SCIMSApi.Migrations
{
    ...
    [Migration("20210209120233_BloodGroupSchoolIdCreate")]
    partial class BloodGroupSchoolIdCreate
    {
            ...
            modelBuilder.Entity("SCIMSApi.Models.BloodGroupInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, BloodGroup = "B+", CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 199, DateTimeKind.Local), Description = "New test of blood group added", IsActive = true, SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.ClassRoomInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 183, DateTimeKind.Local), Description = "Test Class Room", IsActive = true, Name = "Class 1", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.CoursesInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 185, DateTimeKind.Local), Description = "Test Course", IsActive = true, Name = "Course One", SchoolId = 1, TotalMarks = 100 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.DepartmentInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 194, DateTimeKind.Local), Description = "New test department added", IsActive = true, Name = "Urdu", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.DesignationInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 198, DateTimeKind.Local), Description = "New test Designation is created", IsActive = true, Name = "Test Desugnation", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.EmployeeInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "Abu Dhabi Uae", Age = 30, BloodGroupId = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 202, DateTimeKind.Local), DateofBirth = new DateTime(2021, 2, 9, 16, 2, 33, 202, DateTimeKind.Local), DepartmentId = 1, Description = "New Test Employee Added", EmailAddress = "Employee@test.com", EmergencyContactNumber = "123 4546456", GenderId = 1, HireDate = new DateTime(2021, 2, 9, 16, 2, 33, 204, DateTimeKind.Local), ImageUrl = "noImage.png", IsActive = true, MobileNumber = "1235 12132131", Name = "Test Employee", SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.ExamInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 190, DateTimeKind.Local), ExamName = "First Term", IsActive = true, SchoolId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.SchoolInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Address = "Abu Dhabi, UAE", CreatedBy = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 183, DateTimeKind.Local), IsActive = true, Logo = "this.png", Mobile = "91 45454655", Name = "Test School One", Phone = "0302 45454555", RegistrationNo = "011121110" }
                    );
                });
            ...
            modelBuilder.Entity("SCIMSApi.Models.UserInformation", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedDate = new DateTime(2021, 2, 9, 16, 2, 33, 180, DateTimeKind.Local), FullName = "Admin", GenderId = 1, IsActive = true, UserName = "admin@gmail.com", UserPassword = "1234" }
                    );
                });
